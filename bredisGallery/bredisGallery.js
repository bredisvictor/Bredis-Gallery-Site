...
var bredisGallery = {
    ...
    mobileControls: function(){
        ...
        if(clientW>450){
                $(bredisGallery.wrapperNavTop).prependTo("#bredisGallery");
                $("#wrappernavTop").show();
                $(bredisGallery.close).prependTo("#wrappernavTop");
                $(bredisGallery.download).prependTo("#wrappernavTop");
                $(bredisGallery.fullScreenB).prependTo("#wrappernavTop");
                $("#closebutton").css({"right":"0", 
                 ...
                 $(bredisGallery.close).prependTo("#bredisGallery");
    ...
    start: function(index){
        ...
        $(".topB").click(this,function(e){
            ...
            $("#countImg").text(bredisGallery.imageIndex+"/"+bredisGallery.ImageQuantity);
            $("#galeryMain img").eq(0).fadeIn().siblings().hide();
